...
export const confirmModal = document.querySelector(".confirm-modal") as HTMLDivElement;
export const confirmModalOverlay = document.querySelector(".confirm-overlay") as HTMLDivElement;
export const confirmModalHeader = document.querySelector(".confirm-modal--header") as HTMLDivElement;
export const confirmModalHeaderHeading = document.querySelector(".confirm-modal--header__heading") as HTMLHeadingElement;
export const confirmModalBody = document.querySelector(".confirm-modal--body") as HTMLDivElement;
