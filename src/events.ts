...
import { handleMonospaceModeChange, searchElementInputHandler, themeToggleHandler, addFileHandler, backBtnClickHandler, fileNameInputHandler, notepadInputHandler, deleteCurrentFileHandler, exportBtnClickHandler, importBtnClickHandler, importFileHandler, openHelpModal, closeHelpModal, copyFileNameBtnHandler, copyNotepadContentBtnHandler, downloadFileAsTxtHandler, purgeBtnClickHandler } from "./eventHandlers";
import { notepad, fileNameElement, addFileBtn, backBtn, currentDeleteBtn, modeBtn, searchElement, monospaceMode, importBtn, exportBtn, importFile, helpBtn, helpModalOverlay, helpModalCloseBtn, copyFileNameBtn, copyNotepadContentBtn, downloadBtn, confirmModalCloseBtn, confirmModalOverlay, purgeBtn } from "./selectors";
...
export function attachEventListeners() {
  ...
  purgeBtn.addEventListener("click", purgeBtnClickHandler)
